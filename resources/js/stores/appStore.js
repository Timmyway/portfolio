...
export const useAppStore = defineStore('application', () => {
    const technologies = ref({
        ...
        tools: [
            ...
            {"id": 4, "label": "Adobe XD & Figma", "src": "images/icons/figma-icon.png"},
            {"id": 5, "label": "Outils d'IA", "src": "images/icons/chatgpt-icon.png"},
            {"id": 6, "label": "Wordpress", "src": "images/icons/wordpress-icon.png"},
            {"id": 7, "label": "GIT & Github", "src": "images/icons/github-icon.png"},
            {"id": 8, "label": "Nginx", "src": "images/icons/nginx-icon.png"},
        ],
        databases: [
